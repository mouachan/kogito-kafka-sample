...
### Starting required services
  ...
  For MacOS and Windows:
    ...
    docker-compose -f kogito-kafka-services-macos-windows.yml up
  
  For Linux:
  
    docker-compose -f kogito-kafka-services-linux.yml up
...
### Stopping and removing volume data
  ...
  To stop all services, simply run:
    ...
    docker-compose -f kogito-kafka-services-macos-windows.yml stop
    
  It is also recommended to remove any of stopped containers by running:
  
    docker-compose -f kogito-kafka-services-macos-windows.yml rm  
